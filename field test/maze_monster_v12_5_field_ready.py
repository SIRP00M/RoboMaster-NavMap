...
Run:
    python maze_monster.py            # maze solver
...
ENABLE_MOTION = True
PROGRAM_VERSION = 'V12.5_FIELD_READY'
IR_FRONT_LEFT_ID = 1
SHARP_LEFT_ID = 2
SHARP_RIGHT_ID = 3
IR_FRONT_RIGHT_ID = 4
...
# ==================== MAIN INTEGRATION ====================
def choose_v11_decision(explorer, edge_memory, scan):
    """Hard DFS first; latent edge observations are verified only afterwards."""
    ...
    try:
        ...
        while True:
            ...
            if decision_event:
                ...
                exploration_decision, latent_plan = choose_v11_decision(explorer, edge_memory, scan)
...
def monster_cli():
    import argparse
    parser = argparse.ArgumentParser(description='RoboMaster Maze V11.3 monster single-file build')
